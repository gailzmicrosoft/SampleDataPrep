...
param postgresSqlServerHost string // fully qualified server name, e.g. 'myserver.postgres.database.azure.com'
...
var myArguments= '${baseUrl} ${resourceGroup().name} ${keyVaultName} ${postgreSqlServerName} ${postgresSqlServerHost} ${postgreSqlDbName} ${adminPrincipalName} ${identityName}'
