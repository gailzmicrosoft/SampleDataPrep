...
var myArguments= '${baseUrl} ${resourceGroup().name} ${postgreSqlServerName} ${postgresSqlEndPoint} ${postgreSqlDbName} ${identityName}'


resource psql_create_tables 'Microsoft.Resources/deploymentScripts@2020-10-01' = {
  kind:'AzureCLI'
  name: 'AzureCliModuuleRunBashScriptLoadTables'
  ...
  properties: {
    azCliVersion: '2.52.0'
    primaryScriptUri: '${baseUrl}infra/scripts/psql_load_tables_script.sh'
