...
sed -i "s/baseUrl_place_holder/${baseUrl}/g" "run_psql_load_tables_script.py"
sed -i "s/key_vault_name_place_holder/${key_vault_name}/g" "run_psql_load_tables_script.py"
sed -i "s/host_name_place_holder/${host_name}/g" "run_psql_load_tables_script.py"
sed -i "s/database_name_place_holder/${database_name}/g" "run_psql_load_tables_script.py"
sed -i "s/admin_principal_name_place_holder/${admin_principal_name}/g" "run_psql_load_tables_script.py"
sed -i "s/identity_name_place_holder/${identity_name}/g" "run_psql_load_tables_script.py"
