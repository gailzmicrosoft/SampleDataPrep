...
host_name="$4"
database_name="$5"
identity_name="$6"  # managed identity user name. Wil use this to connect to the postgres server 
...
curl --output "psql_load_tables_script.py" ${baseUrl}"infra/scripts/data_scripts/psql_load_tables_script.py"
...
# execute python code
python psql_load_tables_script.py --baseUrl ${baseUrl} --host_name ${host_name} --database_name ${database_name} --identity_name ${identity_name} 
